        ...
        editForm.onsubmit = async (e) => {
          ...
          try {
            ...
            if (response.ok) {
              ...
              document.getElementById('editUserError').textContent = JSON.parse(message).error;
  ...
  createForm.onsubmit = async (event) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        const message = await response.text();
        console.log(message);
        document.getElementById('createUserError').textContent = JSON.parse(message).error;
